...
public class ChangingFace extends Application {
   ...
   public void start(Stage stage) {
      ...
      // create a button that will make the face wink
      Button shockedButton = new Button("Smirk");
      // create and configure a horizontal container to hold the buttons
      HBox buttonBox = new HBox(10);
      buttonBox.setAlignment(Pos.CENTER);
      //add the buttons to the horizontal container
      buttonBox.getChildren().addAll(smileButton, frownButton, shockedButton);
      ...
      // supply the code that is executed when the neutral button is pressed
      shockedButton.setOnAction(e-> {
         
         // Adjust the mouth to form an "O" shape
            mouth.setLength(360);
